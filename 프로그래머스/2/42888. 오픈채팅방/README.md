...
### 회고
- filter 내부에서 side-effect를 일으키는 걸 싫어하는 관점이 있을 수 있다. 이때 그냥 foreach를 사용하는 것이 무난.
- 시간복잡도 O(n) / 공간복잡도 O(n)
- 많은 양이나 빈번한 cd에는 object보단 Map이 적당

### 제출 일자

2025년 05월 27일 22:41:22
